						...
						<h2>Product 1</h2>
						  <div class="panel panel-default">
						    ...
						    <div class="panel-body">
						    	<img src="img/flatblack.jpg" style="width:350px;height:150px;"/>
						    </div>
					...
					<div class="col-sm-4" style="background-color:lavenderblush;">
						<h2>Product 2</h2>
						  <div class="panel panel-default">
						    <div class="panel-heading">Panel Heading</div>
						    <div class="panel-body">
						    	<img src="img/flatorange.jpg" style="width:350px;height:150px;"/>
						    </div>
						    <button type="button" class="btn btn-primary">Book</button>
						  </div>
					</div>
					<div class="col-sm-4" style="background-color:lavenderblush;">
						<h2>Product 3</h2>
						  <div class="panel panel-default">
						    <div class="panel-heading">Panel Heading</div>
						    <div class="panel-body">
						    	<img src="img/flatgreen.jpg" style="width:350px;height:150px;"/>
						    </div>
						    <button type="button" class="btn btn-primary">Book</button>
						  </div>
					</div>
